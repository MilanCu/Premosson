...
const data = [
    {city: "Anom", street: "Go home", id: ""},
    {city: "Megha", street: "Where are", id: ""},
    {city: "Subham", street: "That just", id: ""},
]

//EDIT a DELETE NEFUNGUJE, BE NEIMPLEMENTOVALO
...
export const Places = () => {
    ...
    const [place, setPlace] = useState({city: '', street: '', id: ''});
    ...
    return (
        <div className={styles.container}>
                ...
                {resources.map((val) => {
                    return (
                        <tr className={styles.line}>
                            ...
                            <td>{val.address.houseNumber}</td>
                            <td>{val.address.postalCode}</td>
                            <td>
                                {/*<button*/}
                                {/*    type={'button'}*/}
            ...
            {/*<div>*/}
            {/*    <button className={'button-primary'} onClick={() => setShowCreate(true)}>Add place</button>*/}
            {/*</div>*/}
            {/*<ModalEdit onClose={() => setShowEdit(false)} show={showEdit} data={place}/>*/}
