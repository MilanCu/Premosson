...
const data = [
    {name: "Anom", description: "Go home and drink, grandpa.", place: "Prague 4", id: "sw34"},
    {name: "Megha", description: "Where are my testicles, Summer?", place: "Prague 3", id: "asd6"},
    {name: "Subham", description: "That just sounds like slavery with extra steps.", place: "Prague 2", id: "sd78"},
]

//EDIT A DELETE NEFUNGUJE, na BE neni naimplementovane
...
export const Sources = () => {
    ...
    const [source, setSource] = useState({name: '', description: '', place: ''});
    ...
    return (
        <div className={styles.container}>
            ...
            <div>
                <button className={'button-primary'} onClick={() => setShowCreate(true)}>Add sources</button>
            </div>
            <ModalEdit onClose={() => setShowEdit(false)} show={showEdit} data={source}/>
